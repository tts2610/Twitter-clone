    ...
    return `<div id="content" class="px-5 py-3">
        <div class="row"><div class="col-2"><img src="${element.logo}" id="moreToFollowImg" alt="Avatar">
            ...
            <div class="col-10">
                ...
                <div><i class="fal fa-comment"></i><span class="ml-3">10</span></div>
                <div><i class="far fa-retweet" id="reTweetIcon" onclick="renderModal(${element.id})" style="cursor:pointer;"></i><span class="ml-3">10</span></div>
                <div><i class="fal fa-heart"></i><span class="ml-3">10</span></div>
