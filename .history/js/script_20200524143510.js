...
function renderDescription(description) {
    ...
    desArr.forEach(element => {
        if (element.startsWith("#")) {
            html += `<a onclick="renderHashTags(${element}" href="#">${element}</a>`
        } else {
        ...
        <div class="row"><div class="col-2"><img src="${element.logo}" id="moreToFollowImg" alt="Avatar">
            ...
            <div class="col-10">
                ...
                <span id="tweetTitle">${element.title}</span>
                    ...
                    <div style="display:flex; justify-content: space-between;">${renderDescription(element.content.description)}</div></div>
