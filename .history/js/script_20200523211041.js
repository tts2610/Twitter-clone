...
function renderImgs(tweet) {
    let html;
    return tweet.content.images.map((elem, i) => {
        if (i == 0) {
            html += `<div id="first-row">
            <img id="my-img" style="display: none;" class="firstImg" height="250px" src="${elem}" />`
        } else if (i == 1) {
            html += `<img id="my-img" style="display: none;" class="secondImg" height="250px" src="${elem}" /></div>`
        } else if (i == 2) {
            html += `<div id="second-row">
            <img id="my-img" style="display: none;" class="thirdImg" height="250px" src="${elem}" />`
        } else if (i == 3) {
            html += `<img id="my-img" style="display: none;" class="fourthImg" height="250px" src="${elem}" /></div>`
        }
        return html;
    }).join('')
}
