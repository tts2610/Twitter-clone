...
let news_1 = {
    ...
    content: { description: 'A little hair can make a big difference', images: ['https://pbs.twimg.com/media/EYvsUEaXkAEmHdV?format=jpg&name=medium', 'https://pbs.twimg.com/media/EYvsUOrXgAA7cYE?format=jpg&name=medium', 'https://pbs.twimg.com/media/EYvsUZSXsAA-LQP?format=jpg&name=medium', 'https://pbs.twimg.com/media/EYvsUjTWAAAUAz3?format=jpg&name=medium'], videoLink: "" },
...
let news_2 = {
    ...
    content: { description: 'We should be sliding into #rolandgarros right now, thinking of our mates in Paris &#128079', images: ['https://pbs.twimg.com/media/EYv0V4dUwAA8ZaP?format=jpg&name=4096x4096', 'https://pbs.twimg.com/media/EYv0aypUEAE6-6t?format=jpg&name=4096x4096', 'https://pbs.twimg.com/media/EYv0db9UEAUWrNa?format=jpg&name=4096x4096', 'https://pbs.twimg.com/media/EYv0ffNUwAEJwZF?format=jpg&name=4096x4096'], videoLink: "" },
    time: new Date().toISOString(),
    retweet: "7",
    likes: "20",
    comments: "10",
