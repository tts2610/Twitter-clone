...
function renderFromList() {
    ...
    let html = tweetList.map(element => {
        ...
        <div class="row pt-3 functionBar">
                ...
                <i class="far fa-retweet" data-toggle="modal" data-target="#retweetModal" onclick="renderModal(${element})" style="cursor:pointer;"></i>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-11" style="padding-left: 40px;">
                        <div contenteditable="true" placeholder="What's happening" id="tweetArea"></div>
                        <div id="image-container">
                            <div id="first-row">
                                <img id="my-img" style="display: none;" class="firstImg" height="250px" src="#" />

                                <img id="my-img" style="display: none;" class="secondImg" height="250px" src="#" />

                            </div>

                            <div id="second-row">
                                <img id="my-img" style="display: none;" class="thirdImg" height="250px" src="#" />

                                <img id="my-img" style="display: none;" class="fourthImg" height="250px" src="#" />
