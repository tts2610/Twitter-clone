...
function renderFromList() {
    ...
    let html = tweetList.map(element => {
        ...
        <div class="row pt-3 functionBar">
                ...
                <i class="far fa-retweet" id="reTweetIcon" onclick="renderModal('${element.content.description}',${JSON.stringify(element.content.images)})" style="cursor:pointer;"></i>
