...
function renderImgs(tweet) {
    ...
    tweet.content.images.forEach((elem, i) => {
        if (i == 0) {
            html += `<div id="first-row"><img id="my-img" class="tweet" style="display: block;" height="250px" src="${elem}" />`
        } else if (i == 1) {
            html += `<img id="my-img" style="display: block;" class="tweet" height="250px" src="${elem}" /></div>`
        } else if (i == 2) {
            html += `<div id="second-row"><img id="my-img" class="tweet-1" style="display: block;" height="250px" src="${elem}" />`
        } else if (i == 3) {
            html += `<img id="my-img" style="display: block;" class="tweet-1" height="250px" src="${elem}" /></div>`
        }
    });
    return html;
}
