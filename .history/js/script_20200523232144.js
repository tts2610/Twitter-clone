...
function renderFromList() {
    ...
    let html = tweetList.map(element => {
        let modalElement = JSON.stringify(element);
        return `
        ...
        <div class="row pt-3 functionBar">
                ...
                <i class="far fa-retweet" data-toggle="modal" data-target="#retweetModal" onclick="${renderModal(JSON.stringify(element))}" style="cursor:pointer;"></i>
...
function renderModal(element) {
    let thisElement = JSON.parse(element);
    $("#retweetModal").remove();
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="utilityBar">
                    ...
                    <button class="tweetbtn inputArea-tweetbtn" href="#" onclick="post()" style="width: 100px; margin-left: 21px;">Tweet</button>
