...
const post = () => {
    ...
    let myTweet = {
        ...
        content: { description: "", images: [], videoLink: "https://www.youtube.com/embed/bTqVqk7FSmY?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1" },
        ...
        <div class="row"><div class="col-2"><img src="${element.logo}" id="moreToFollowImg" alt="Avatar">
            ...
            <div class="col-10">
                ...
                <span id="tweetTitle">${element.title}</span>
                    ...
                    <div id="player" style="width:200px; height:300px;">
                    <iframe
                    src="https://www.youtube.com/embed/bTqVqk7FSmY?origin=https://plyr.io&amp;iv_load_policy=3&amp;modestbranding=1&amp;playsinline=1&amp;showinfo=0&amp;rel=0&amp;enablejsapi=1?autoplay=1"
                    allowfullscreen
                    allowtransparency
                    allow="autoplay"
