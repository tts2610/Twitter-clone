...
function renderFromList() {
    ...
    let html = tweetList.map(element => {
        ...
        let myList = JSON.stringify(element.content.images);
        return `
        ...
        <div class="row pt-3 functionBar">
                ...
                <i class="far fa-retweet" id="reTweetIcon" onclick="renderModal('${element.content.description}',${myList.toString()})" style="cursor:pointer;"></i>
...
function renderModal(des, images) {
