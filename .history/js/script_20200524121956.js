...
const countLetter = (e) => {
    ...
    // tweetArea.bind('keypress', function(e) {
    //     if ((e.keyCode || e.which) == 32) {

    //     }
    //     if ((e.keyCode || e.which) == 35) {
    //         alert("aaa");
    //         console.log(tweetArea.text());
    //         let hashTag = `<span id="inputArea-hashtag" style="color:blue;">${tweetArea.text()}</span>`
...
$(document).ready(function() {
    ...
    checkInputFields();
    tweetArea.on('input propertychange keypress', countLetter(e));
