...
function renderImgs(tweet) {
    ...
    tweet.content.images.forEach((elem, i) => {
        if (i == 0) {
            ...
            <img id="my-img" style="display: block;" class="firstImg" height="250px" src="${elem}" />`
        } else if (i == 1) {
            html += `<img id="my-img" style="display: block;" class="secondImg" height="250px" src="${elem}" /></div>`
        } else if (i == 2) {
            html += `<div id="second-row">
            <img id="my-img" style="display: block;" class="thirdImg" height="250px" src="${elem}" />`
        } else if (i == 3) {
            html += `<img id="my-img" style="display: block;" class="fourthImg" height="250px" src="${elem}" /></div>`
        }
    });
    return html;
}
